...
With the currentcolor keyword
 -->
	<img src="common/img/color1.png" alt="" />
...
For example, rgb(0,0,255) is rendered as blue, because the blue parameter is set to its highest value (255) and the others are set to 0.
 -->
	<br>
	<img src="common/img/color3.png" alt="" />

	<br>
	<img src="common/img/color4.png" alt="" />

	<br>
	<img src="common/img/color5.png" alt="" />
...
In the next chapter you will find a complete alphabetical list of color names with hexadecimal values:
 -->
	...
	<br>
	<img src="common/img/color6.png" alt="" />
